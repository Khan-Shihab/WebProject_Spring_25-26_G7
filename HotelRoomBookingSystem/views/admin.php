...
<div class="page-wrapper">
    ...
    <div class="main-content">
                ...
                <form method="POST" action="../controllers/roomtypeController.php" enctype="multipart/form-data">
                    ...
                    <div class="two-col">
                        ...
                        <div>
                            ...
                            <input type="number" name="price_per_night" placeholder="5000" min="1">
                        </div>
                    </div>
        ...
        <div id="section-rooms" class="section" style="display:none;">
            ...
            <h2>Rooms</h2>
            <p class="subtitle">Manage individual rooms</p>

            <!-- Add Room Form -->
            <div class="form-box">
                <h3 class="form-box-title">Add New Room</h3>
                <form method="POST" action="../controllers/roomController.php">

                    <div class="two-col">
                        <div>
                            <label>Room Number</label>
                            <input type="text" name="room_number" placeholder="101">
                        </div>
                        <div>
                            <label>Floor</label>
                            <input type="number" name="floor" placeholder="1" min="1">
                        </div>
                    </div>
            ...
            <div class="form-box" style="padding:0; overflow:hidden;">
                <table class="admin-table">
                    ...
                    <tbody>
                        <!-- PHP loop from rooms LEFT JOIN bookings -->
                        <tr>
                            <td>101</td>
                            <td>1</td>
                            <td>Deluxe</td>
                            <td>
                                <button class="status-toggle available-badge"
                                    onclick="toggleStatus(1, this)">Available</button>
                            </td>
                            <td>
                                <a href="#" class="edit-link">Edit</a>
                                <a href="#" class="delete-link">Delete</a>
                        ...
                        <tr>
                            ...
                            <td>Standard</td>
                            <td>
                                <button class="status-toggle booked-badge"
                                    onclick="toggleStatus(2, this)">Booked</button>
                            </td>
                            <td>
                                <a href="#" class="edit-link">Edit</a>
                                <a href="#" class="delete-link">Delete</a>
                        ...
                        <tr>
                            ...
                            <td>Suite</td>
                            <td>
                                <button class="status-toggle maintenance-badge"
                                    onclick="toggleStatus(3, this)">Maintenance</button>
                            </td>
                            <td>
                                <a href="#" class="edit-link">Edit</a>
                                <a href="#" class="delete-link">Delete</a>
        ...
        <div id="section-bookings" class="section" style="display:none;">
            ...
            <div class="form-box">
                ...
                <form method="GET" action="">
                    ...
                    <button type="submit" style="width:auto; padding:8px 24px; margin-top:12px;">Apply Filter</button>
                </form>
            </div>
