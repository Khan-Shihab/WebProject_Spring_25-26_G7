            ...
            <div>
                <div class="form-box">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">Reduanul Islam</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Email</span>
                        <span class="detail-value">reduan@gmail.com</span>
                    </div>
                    <div class="detail-row">
                ...
                <div class="form-box action-box">
                    ...
                    <!-- Show Check In button only if:
                         status = Confirmed AND checkin_date = today -->
                    ...
                    <!-- After Check In, JS swaps button to Check Out -->
                    <!-- After Check Out, button becomes disabled -->
                </div>
            </div>
